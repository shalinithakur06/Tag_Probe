...
class Ntupler : public edm::EDAnalyzer {
  ...
  // Trigger names and decision 
     ...
     std::vector<bool> passFilterEle27; ///added by me
     ...
     Int_t nElectrons_;
     std::vector<double> ele_dEtaInSeed_;  ////added by me from 654-669
     std::vector<double> ele_iEminusiP_;  
     std::vector<double> ele_nInnerHits_;
     std::vector<double> ele_nInnerLostHits_;
     std::vector<double> ele_isPassConVeto_;
     std::vector<double> ele_isEcalDriven_;
     std::vector<double> ele_energy5x5_;
     std::vector<double> ele_energy2x5_;
     std::vector<double> ele_energy1x5_;
     std::vector<double> ele_eleRho_;
     std::vector<double> ele_eleTrkPt_;
     std::vector<double> ele_GsfEleEmHadD1IsoRhoCut_;
     std::vector<double> ele_relCombPFIsoEA_;
     std::vector<double> ele_PileupIso_;
     std::vector<Int_t> ele_isEE_;
     std::vector<Int_t> ele_isEB_;
